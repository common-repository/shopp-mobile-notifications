<?php
/*
Plugin Name: Shopp + Mobile Notifications
Description: Merchants who have a WordPress ecommerce store are notified of new orders via a text message to their mobile phone.
Version: 1.3
...
Shopp_MobileNotifications::smartLoad();

class Shopp_MobileNotifications {
	public static $from = 'Replace with the name of your store';
	public static $subject= 'Replace with a subject';
	public static $message;
	public static $to;
	
	public static function smartLoad() {
		$instantiate = apply_filters('shoppMobileNotificationsLoadBasic', true);
		if ($instantiate) { new Shopp_MobileNotifications; }
	}
	
	public function __construct() {
		add_action('admin_init', array($this, 'admin_css'));
		add_action('admin_menu', array($this, 'admin_menu'));
		add_action('shopp_order_success', array($this, 'create_mobile_notification'));
		
		$this->from = get_option('smn_from');		
		$this->subject = get_option('smn_subject');
		$this->message = get_option('smn_message');
		$this->to = get_option('smn_to');
	}
	
	public function admin_css() {
		wp_register_style( 'shopp-mobile-notifications-stylesheet', plugins_url( 'css/shopp-mobile-notifications.css', __FILE__ ), array(), '20140823' );
		wp_enqueue_style( 'shopp-mobile-notifications-stylesheet' );
	}
	...
	public function admin_menu() {
		...
		$page = add_submenu_page('shopp-101-extensions', 'Mobile Notifications', 'Mobile Notifications', 'shopp_menu', 'shopp-mobile-notifications', array($this, 'render_display_settings'));
        add_action( 'admin_print_styles-' . $page, 'admin_styles' );
		...
		<div class="metabox-holder">	
			...
			<div id="shopp-extensions-about-the-author" class="postbox">
				...
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
                            <td width="70%"><div><img style="padding: 0px 15px 0px 0px; float:left" src="<?php echo plugins_url( 'shopp-mobile-notifications/images/lorenzo-orlando-caum-shopp-wordpress-150x150.jpg' , dirname(__FILE__) ); ?>" border="0" alt="Founder of Enzo12 LLC" width="150" height="150">
...
<?php	 	 
	...
	public function create_mobile_notification($Purchase) {
		global $wpdb;

		/*	
			Refer to Shopp Purchase API call: https://shopplugin.net/api/category/theme/shopp-purchase/
	...
	public function render_display_settings() {
		wp_nonce_field('shopp-mobile-notifications');
		...
		if(!empty($_POST['submit'])){
			...
			update_option("smn_from", $this->from);
			update_option("smn_subject", $this->subject);
			update_option("smn_message", $this->message);
			update_option("smn_to", $this->to);

		}	
?>

<div class="wrap">
	<h2>Shopp + Mobile Notifications</h2>
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	

			<div id="shopp-mobile-notifications-introduction" class="postbox">
				<h3 class="hndle"><span>Introduction</span></h3>
				<div class="inside">
					<p>This plugin integrates <a href="http://shopp101.com/go/shopp/" title="Learn more about Shopp">Shopp</a> with mobile notifications</a> and is part of the Shopp 101 extensions.</p> 
			...
			<div id="shopp-mobile-notifications-general-settings" class="postbox">
				<h3 class="hndle"><span>Setup Tutorial</span></h3>
				<div class="inside">
				<p><strong>How to Find Your Information for Mobile Notifications</strong><br /><br /><iframe src="http://player.vimeo.com/video/39086357?title=0&amp;byline=0&amp;portrait=0" width="600" height="300" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></p>
                <p>Pro-tip: After starting a video, click on the fullscreen button which appears to the right of the HD toggle.</p>
				</div>
			</div>
			
			<div id="shopp-mobile-notifications-support-feedback" class="postbox">
				<h3 class="hndle"><span>Support & Feedback</span></h3>
				<div class="inside">
                ...
                <p>You can share feedback via this a <a href="http://shopp101.com/go/shopp-extensions-survey/" title="Take a super short survey">short survey</a>. Takes just a few minutes &mdash; we promise!</p>
                <p>Feeling generous? You can support the continued development of the Shopp + Mobile Notifications by <a href="http://shopp101.com/go/donate-shopp-mobile-notifications/" title="Say thank you by purchasing Lorenzo a Redbull">buying me a Redbull</a>, <a href="http://shopp101.com/go/amazonwishlist/" title="Say thank you by gifting Lorenzo a book">ordering me a book</a> from my Amazon wishlist, or <a href="http://shopp101.com/go/tip-shopp-help-desk/" title="Say thank you by tipping Lorenzo via the Shopp Help Desk">tipping me</a> through the Shopp help desk.</p>
				</div>
			</div>
			
			<div id="shopp-mobile-notifications-settings" class="postbox">
				<h3 class="hndle"><span>Mobile Notifications Settings</span></h3>
				<div class="inside">
					<p>The message field that appears below is <strong>disabled</strong>.</p> 
					<p>Shopp + Mobile Notifications will send new order information in the following format:</p>
					<p>FRM: From<br />
					SUBJ: Subject<br />
					MSG: <br />
					...
					<tr>
						<th>From</th>
						<td><input type="text" name="from" size="35" value="<?php echo $this->from; ?>" /></td>
					</tr>
					<tr>
						<th>Subject</th>
						<td><input type="text" name="subject" size="35" value="<?php echo $this->subject; ?>" /></td>
					</tr>
					<tr>
						<th>Message</th>
			...
			<div id="shopp-mobile-notifications-about-the-author" class="postbox">
				<h3 class="hndle"><span>About the Author</span></h3>
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
	...
	<div class="postbox-container" style="width:25%;">
		<div class="metabox-holder">
			...
			<div id="shopp-mobile-notifications-donate" class="postbox">
				<h3 class="hndle"><span><strong>Make a Donation!</strong></span></h3>
				<div class="inside">
					<p>Hi friend!</p>
					<p>If this plugin is helpful to you, then please <a href="http://shopp101.com/go/donate-shopp-mobile-notifications/" title="Say thank you by purchasing Lorenzo a Redbull">buy me a Redbull</a>.</p> 
					...
					<p>Your kindness is appreciated and will go towards <em>continued development</em> of the Shopp + Mobile Notifications plugin.</p>
				</div>
			</div>
			
			<div id="shopp-mobile-notifications-subscribe" class="postbox">
			...
			<div id="shopp-mobile-notifications-have-a-question" class="postbox">
				<h3 class="hndle"><span>Have a Question?</span></h3>
				<div class="inside">
                    <p>Open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> for Shopp + Mobile Notifications</p>
			...
			<div id="shopp-mobile-notifications-news-from-oms" class="postbox">
				<h3 class="hndle"><span>News from Shopp 101</span></h3>
				<div class="inside">
				<p>Free Report<br /> <a href="http://shopp101.com/newsletter/" title="Receive your free report delivered instantly to your inbox">10 Steps to a More Secure WordPress</a></p>
				<p>Documents & Presentations<br /> <a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on creating a fast Shopp website">Speeding up your Shopp Ecommerce Website</a><br /><a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on using Shopp with caching plugins">Shopp + Caching Plugins</a></p>
			...
			<div id="shopp-mobile-notifications-recommendations" class="postbox">
